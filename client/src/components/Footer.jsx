...
const Footer = () => {
  return (
    ...
    >
      <div
        className={
          "w-full flex sm:flew-row flex-col justify-between items-center my-4"
        }
      >
      ...
      >
        <p className={"text-white text-small text-center"}>@coinchange 2022</p>
        <p className={"text-white text-small text-center"}>
          All rights reserved
        </p>
      </div>
